...
export default {
              ...
              h('span', {
                ...
                on: {
                  click: () => {
                    ...
                    switch (this.detailData.applicationStatus) {
                      case 'AGENCY':
                        this.showModal = true
  ...
  methods: {
    ...
    sendRequest (index, obj) { /* 发送请求 */
      this.request('post', 'http://localhost:8088/application/get/customPage?page=' + index + '&size=15', obj)
        .then((data) => {
          this.dealData(data)
        }).catch((response) => {
          this.$Modal.warning({
